  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: How to make the dough for Cinnamon Rolls:
        <ol id="wd-your-favorite-recipe">
          <li>
            In a small bowl, dissolve yeast in warm water with 1 tbsp of
            granulated sugar. Let it sit until frothy (about 5–10 minutes).
          </li>
          <li>
            In a large bowl, add sugar, butter, salt, eggs and warm milk and
            beat it separately. To this mixture add the vanilla essence and
            yeast mixture.
          </li>
          <li>
            Once the mixture is beaten, add half of the flour and again beat
            with the hook adapter. Then once it’s blended well add the rest of
            the flour and again mix. Knead the dough for 5–10 minutes until
            smooth and elastic.
          </li>
          <li>
            Place in a greased bowl, cover, and let rise in a warm place for 1
